-- =============================================
-- INKA Clothing E-Commerce — Seed Data (PostgreSQL)
-- =============================================
...
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (1, 'Crew Neck', NULL, 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (2, 'V-Neck', NULL, 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (3, 'Polo', NULL, 1) ON CONFLICT (id) DO NOTHING;

-- Sub Categories for Denims (category_id = 2)
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (4, 'Slim Fit', NULL, 2) ON CONFLICT (id) DO NOTHING;
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (5, 'Regular', NULL, 2) ON CONFLICT (id) DO NOTHING;
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (6, 'Wide Leg', NULL, 2) ON CONFLICT (id) DO NOTHING;

-- Sub Categories for Tote Bags (category_id = 3)
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (7, 'Small', NULL, 3) ON CONFLICT (id) DO NOTHING;
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (8, 'Medium', NULL, 3) ON CONFLICT (id) DO NOTHING;
INSERT INTO sub_category (id, name, image_url, category_id) VALUES (9, 'Large', NULL, 3) ON CONFLICT (id) DO NOTHING;
